...
metadata:
  ...
  requires: runtime - Python 3.12+, uv package manager
  ...
  user-confirmation-required: First-time install (uv tool install): downloads external package. Browser creation: requires explicit user approval. Sensitive operations: login, form submission, file upload require user confirmation.
---
